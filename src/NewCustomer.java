...
public class NewCustomer extends JFrame implements ActionListener{
    ...
    NewCustomer(){
        ...
        c = new JComboBox(new String[] {"Andhra Pradesh","Arunachal Pradesh","Assam","Bihar","Chhattisgarh","Goa","Gujarat","Haryana","Himachal Pradesh","Jammu and Kashmir", "Jharkhand","Karnataka","Kerala","Madhya Pradesh","Maharashtra","Manipur","Meghalaya","Mizoram","Nagaland","Odisha","Punjab","Rajasthan","Sikkim","Tamil Nadu","Telangana", "Tripura","Uttarakhand","Uttar Pradesh", "West Bengal","Andaman and Nicobar Islands","Chandigarh","Dadra and Nagar Haveli","Daman and Diu","Delhi","Lakshadweep","Puducherry"});
        c.setBounds(240, 240, 200, 20);
        p.add(l4);
        p.add(c);
    ...
    public void actionPerformed(ActionEvent ae){
    	...
    	boolean r =z.matches(indiaRegex);
    	if(ae.getSource() ==b2){
    	...
    	if(ae.getSource() == b1){
            ...
            String state = (String)c.getSelectedItem();
